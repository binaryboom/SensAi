...
! function webpackUniversalModuleDefinition(t, e) {
    ...
    var __webpack_modules__ = [, (t, e) => {
            ...
            function getDocument(t) {
                ...
                else if ((0, _util.isArrayBuffer)(t)) t = {
                    data: t
                };
                ...
                } else if ("object" != typeof t) throw new Error("Invalid parameter in getDocument, need either string, URL, TypedArray, or parameter object.");
                ...
                const e = new PDFDocumentLoadingTask,
                    ...
                    l = Number.isInteger(t.rangeChunkSize) && t.rangeChunkSize > 0 ? t.rangeChunkSize : DEFAULT_RANGE_CHUNK_SIZE;
                let c = t.worker instanceof PDFWorker ? t.worker : null;
                const h = t.verbosity,
                    d = "string" != typeof t.docBaseUrl || (0, _display_utils.isDataScheme)(t.docBaseUrl) ? null : t.docBaseUrl,
                    ...
                    R = "boolean" == typeof t.useSystemFonts ? t.useSystemFonts : !_is_node.isNodeJS && !y,
                    M = "boolean" == typeof t.useWorkerFetch ? t.useWorkerFetch : g === _display_utils.DOMCMapReaderFactory && m === _display_utils.DOMStandardFontDataFactory && (0, _display_utils.isValidFetchUrl)(u, document.baseURI) && (0, _display_utils.isValidFetchUrl)(f, document.baseURI);
                (0, _util.setVerbosityLevel)(h);
                const F = M ? null : {
                    cMapReaderFactory: new g({
                        baseUrl: u,
                        isCompressed: p
                    }),
                    standardFontDataFactory: new m({
                        baseUrl: f
                    })
                };
                if (!c) {
                ...
                c.promise.then((function() {
                    ...
                    const t = _fetchDocument(c, I),
                        r = new Promise((function(t) {
                            let e;
                            o ? e = new _transport_stream.PDFDataTransportStream({
                                length: k,
                                initialData: o.initialData,
                                progressiveDone: o.progressiveDone,
                                contentDispositionFilename: o.contentDispositionFilename,
                                disableRange: C,
                                disableStream: P
                            }, o) : n || (e = createPDFNetworkStream({
                                url: s,
                                length: k,
                                httpHeaders: i,
                                withCredentials: a,
            ...
            class PDFWorker {
                ...
                constructor({
                    ...
                    if (e && PDFWorker.#i.has(e)) throw new Error("Cannot use more than one PDFWorker per port.");
                    this.name = t;
                    this.destroyed = !1;
                    this.verbosity = s;
                    this._readyCapability = (0, _util.createPromiseCapability)();
            ...
            class InternalRenderTask {
                ...
                initializeGraphics({
                    ...
                    if (this._canvas) {
                        if (InternalRenderTask.#u.has(this._canvas)) throw new Error("Cannot use the same canvas during multiple render() operations. Use different canvas or ensure previous operations were cancelled or completed.");
            ...
            class AnnotationEditor {
                ...
                static deserialize(t, e, s) {
                    ...
                    const [i, a] = n.pageDimensions, [r, o, l, c] = n.getRectInCurrentCoords(t.rect, a);
                    n.x = r / i;
                    n.y = o / a;
                    n.width = l / i;
                    n.height = c / a;
            ...
            e.getXfaPageViewport = function getXfaPageViewport(t, {
                ...
                const {
                    width: n,
                    height: i
                } = t.attributes.style, a = [0, 0, parseInt(n), parseInt(i)];
            ...
            e.setLayerDimensions = function setLayerDimensions(t, e, s = !1, n = !0) {
                if (e instanceof PageViewport) {
                    const {
                        ...
                        style: a
                    } = t, r = `calc(var(--scale-factor) * ${n}px)`, o = `calc(var(--scale-factor) * ${i}px)`;
                    ...
                    a.onreadystatechange = () => {
                        if (a.readyState === XMLHttpRequest.DONE) {
                            if (200 === a.status || 0 === a.status) {
                                let t;
                                e && a.response ? t = new Uint8Array(a.response) : !e && a.responseText && (t = (0, i.stringToBytes)(a.responseText));
                                if (t) {
                                    s(t);
                                    return
                                }
            ...
            e.StatTimer = class StatTimer {
                ...
                toString() {
                    ...
                    for (const {
                        ...
                        of this.times) t.push(`${s.padEnd(e)} ${i-n}ms\n`);
                    return t.join("")
                }
            };
            ...
            class CanvasGraphics {
                ...
                beginDrawing({
                    ...
                    if (this.foregroundColor && this.backgroundColor) {
                        ...
                        if ("#000000" === t && "#ffffff" === e || t === e || !s) this.foregroundColor = this.backgroundColor = null;
                            ...
                            const [s, a, r] = (0, i.getRGB)(n), newComp = t => (t /= 255) <= .03928 ? t / 12.92 : ((t + .055) / 1.055) ** 2.4, o = Math.round(.2126 * newComp(s) + .7152 * newComp(a) + .0722 * newComp(r));
                    ...
                    if (s) {
                        ...
                        this.ctx = t.context;
                        this.ctx.save();
                        this.ctx.transform(...(0, i.getCurrentTransform)(this.compositeCtx))
                    }
                    this.ctx.save();
                ...
                _scaleImage(t, e) {
                    const s = t.width,
                        n = t.height;
                    let i, a, r = Math.max(Math.hypot(e[0], e[1]), 1),
                ...
                _createMaskCanvas(t) {
                    ...
                    y.transform(...g);
                    if (!u) {
                        u = this._scaleImage(p.canvas, (0, i.getCurrentTransformInverse)(y));
                        u = u.img;
                        h && l && h.set(d, u)
                    }
                    y.imageSmoothingEnabled = getImageSmoothingEnabled((0, i.getCurrentTransform)(y), t.interpolate);
                    drawImageAtIntegerCoords(y, u, 0, 0, u.width, u.height, 0, 0, s, r);
                    y.globalCompositeOperation = "source-in";
                    const E = n.Util.transform((0, i.getCurrentTransformInverse)(y), [1, 0, 0, 1, -S, -x]);
                ...
                constructPath(t, e, s) {
                    ...
                    const d = (0, i.getCurrentTransform)(a),
                        ...
                        p = u ? s.slice(0) : null;
                    for (let s = 0, i = 0, g = t.length; s < g; s++) switch (0 | t[s]) {
                ...
                showText(t) {
                    ...
                    if (e.patternFill) {
                        o.save();
                        const t = e.fillColor.getPattern(o, this, (0, i.getCurrentTransformInverse)(o), a.PathType.FILL);
                    ...
                    if (0 === y || 0 === v) {
                        ...
                        t !== n.TextRenderingMode.STROKE && t !== n.TextRenderingMode.FILL_STROKE || (v = this.getSinglePixelWidth())
                    } else v /= y;
                    if (1 !== l) {
                        o.scale(l, l);
                        v /= l
                ...
                getColorN_Pattern(t) {
                    ...
                    if ("TilingPattern" === t[0]) {
                        const s = t[1],
                            n = this.baseTransform || (0, i.getCurrentTransform)(this.ctx),
                            r = {
                ...
                beginGroup(t) {
                    ...
                    let a = n.Util.getAxialAlignedBoundingBox(t.bbox, (0, i.getCurrentTransform)(e));
                ...
                beginAnnotation(t, e, s, a, r) {
                    ...
                    if (Array.isArray(e) && 4 === e.length) {
                        ...
                        if (r && this.annotationCanvasMap) {
                            ...
                            e[2] = a;
                            e[3] = o;
                            const [r, l] = n.Util.singularValueDecompose2dScale((0, i.getCurrentTransform)(this.ctx)), {
                                viewportScale: c
                    ...
                    if (n) {
                        void 0 === n.compiled && (n.compiled = function compileType3Glyph(t) {
                            ...
                            const n = new Uint8Array([0, 2, 4, 0, 1, 0, 5, 4, 8, 10, 0, 8, 0, 2, 1, 0]),
                                i = e + 1;
                            let a, r, o, c = new Uint8Array(i * (s + 1));
                            const h = e + 7 & -8;
                ...
                paintImageMaskXObjectGroup(t) {
                    ...
                    for (const r of t) {
                        ...
                        d.fillStyle = n ? s.getPattern(d, this, (0, i.getCurrentTransformInverse)(e), a.PathType.FILL) : s;
                        d.fillRect(0, 0, o, l);
                        d.restore();
                        e.save();
                        e.transform(...c);
                ...
                paintImageXObjectRepeat(t, e, s, i) {
                    ...
                    const r = a.width,
                        o = a.height,
                        l = [];
                    for (let t = 0, n = i.length; t < n; t += 2) l.push({
                ...
                paintInlineImageXObject(t) {
                    ...
                    const r = this._scaleImage(a, (0, i.getCurrentTransformInverse)(n));
                ...
                getScaleForStroking() {
                    if (!this._cachedScaleForStroking) {
                        const {
                            lineWidth: t
                        } = this.current, e = (0, i.getCurrentTransform)(this.ctx);
                        let s, n;
                        if (0 === e[1] && 0 === e[2]) {
                ...
                rescaleAndStroke(t) {
                    const {
                        ...
                        lineWidth: s
                    } = this.current, [n, a] = this.getScaleForStroking();
                    e.lineWidth = s || 1;
                    if (1 === n && 1 === a) {
                        e.stroke();
                        return
            ...
            e.OptionalContentConfig = class OptionalContentConfig {
                ...
                constructor(t) {
                    ...
                    if (null !== t) {
                        ...
                        this.#mt = t.order;
                        for (const e of t.groups) this.#gt.set(e.id, new OptionalContentGroup(e.name, e.intent));
                        if ("OFF" === t.baseState)
                ...
                getOrder() {
                    return this.#gt.size ? this.#mt ? this.#mt.slice() : [...this.#gt.keys()] : null
                }
                getGroups() {
            ...
            e.PDFDataTransportStream = class PDFDataTransportStream {
                constructor({
                    ...
                    (0, n.assert)(o, 'PDFDataTransportStream - missing required "pdfDataRangeTransport" argument.');
                    this._queuedChunks = [];
                ...
                _onReceiveData({
                    ...
                    if (void 0 === t) this._fullRequestReader ? this._fullRequestReader._enqueue(s) : this._queuedChunks.push(s);
                        ...
                        (0, n.assert)(e, "_onReceiveData - no `PDFDataTransportStreamRangeReader` instance found.")
                    }
                }
            ...
            class AnnotationEditorLayer {
                ...
                addInkEditorIfNeeded(t) {
                    if (!t && this.#Ct.getMode() !== n.AnnotationEditorType.INK) return;
                    if (!t)
            ...
            class FreeTextEditor extends a.AnnotationEditor {
                ...
                static get defaultPropertiesToUpdate() {
                    return [
                        ...
                        [n.AnnotationEditorParamsType.FREETEXT_COLOR, FreeTextEditor._defaultColor || a.AnnotationEditor._defaultLineColor]
                    ]
                }
                get propertiesToUpdate() {
                    return [
            ...
            class InkEditor extends i.AnnotationEditor {
                ...
                onScaleChanging() {
                    const [t, e] = this.parentDimensions, s = this.width * t, n = this.height * e;
                ...
                #ge(t, e) {
                    ...
                    let i;
                    if (1 !== this.currentPath.length) i = (0, a.fitCurve)(this.currentPath, 30, null);
                    else {
                        const s = [t, e];
                        i = [
                            [s, s.slice(), s.slice(), s]
                ...
                #ye(t, e, s, n) {
                    ...
                    for (const l of this.paths) {
                        ...
                        for (let i = 0, c = l.length; i < c; i++) {
                            const [c, h, d, u] = l[i], p = t * (c[0] + e) + a, g = n - t * (c[1] + s) - a, f = t * (h[0] + e) + a, m = n - t * (h[1] + s) - a, b = t * (d[0] + e) + a, A = n - t * (d[1] + s) - a, _ = t * (u[0] + e) + a, v = n - t * (u[1] + s) - a;
                            if (0 === i) {
                                r.push(p, g);
                                o.push(p, g)
                            }
                ...
                static deserialize(t, e, s) {
                    ...
                    i.opacity = t.opacity;
                    const [a, r] = i.pageDimensions, l = i.width * a, c = i.height * r, h = i.parentScale, d = t.thickness / 2;
                    i.#Ht = l / c;
                    i.#Kt = !0;
                    i.#te = Math.round(l);
                    i.#ee = Math.round(c);
                ...
                serialize() {
                    ...
                    return {
                        ...
                        paths: this.#ye(this.scaleFactor / this.parentScale, this.translationX, this.translationY, e),
                        pageIndex: this.pageIndex,
                        rect: t,
                        rotation: this.rotation
                    }
            ...
            function generateAndReport(t, e, s, n, i, a) {
                ...
                r = function generateBezier(t, e, s, n) {
                    var i, a, r, o, l, c, h, d, u, p, g, f, m, b, A, _, v, y = t[0],
                        S = t[t.length - 1];
                    i = [y, null, null, S];
            ...
            class AnnotationElement {
                ...
                _createContainer(t = !1) {
                    ...
                    const {
                        ...
                        width: h,
                        height: d
                    } = getRectDims(e.rect), u = n.Util.normalizeRect([e.rect[0], s.view[3] - e.rect[1] + s.view[1], e.rect[2], s.view[3] - e.rect[3] + s.view[1]]);
                ...
                _getElementsByName(t, e = null) {
                    ...
                    for (const n of document.getElementsByName(t)) {
                        const {
                            exportValue: t
                        } = n, i = n.getAttribute("data-element-id");
                        i !== e && (c.has(n) && s.push({
                            id: i,
                            exportValue: t,
                            domElement: n
                            ...
                            const i = {
                                ...
                                insert(s) {
                                    const {
                                        ...
                                        displayValue: a,
                                        exportValue: o
                                    } = s.detail.insert, l = n.children[i], c = document.createElement("option");
                                    c.textContent = a;
                                    c.value = o;
                ...
                const o = {
                    ...
                    u = function() {
                        ...
                        function encode(s, n, r, o) {
                            ...
                            const b = new Uint8Array([l >> 24 & 255, l >> 16 & 255, l >> 8 & 255, 255 & l, c >> 24 & 255, c >> 16 & 255, c >> 8 & 255, 255 & c, h, d, 0, 0, 0]),
                ...
                e.SVGGraphics = r = class {
                    ...
                    _makeTilingPattern(t) {
                        const e = t[1],
                            ...
                            d = t[7],
                            u = "shading" + f++,
                            [p, g, m, b] = i.Util.normalizeRect([...i.Util.applyTransform([a, r], n), ...i.Util.applyTransform([o, l], n)]),
                    ...
                    constructPath(t, e) {
                        ...
                        r = r.join(" ");
                        if (s.path && t.length > 0 && t[0] !== i.OPS.rectangle && t[0] !== i.OPS.moveTo) r = s.path.getAttributeNS(null, "d") + r;
                        else {
